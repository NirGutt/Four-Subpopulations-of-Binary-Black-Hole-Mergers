...
The posterior corner plots are organized by model, component, and parameter group.

### Mass parameters

| Component | Component-spin model | Effective-spin model |
|---|---|---|
...
The four components are referred to in this repository as:
...
| High-mass | Upper-mass component extending to high masses |
