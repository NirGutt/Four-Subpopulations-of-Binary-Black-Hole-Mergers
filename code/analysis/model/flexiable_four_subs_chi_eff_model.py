...
class PiStrokeFourComponentMassSpin:
    ...
    variable_names = [
        ...
        # Independent Gaussian for component 1
        
        "mu_chi_eff_1",
        "sigma_chi_eff_1",

        # Independent Gaussian for component 2
        "mu_chi_eff_2",
        "sigma_chi_eff_2",

        # Independent Gaussian for component 3
        "mu_chi_eff_3",
        "sigma_chi_eff_3",

        # Independent Gaussian for component 4
        "mu_chi_eff_4",
        "sigma_chi_eff_4",
