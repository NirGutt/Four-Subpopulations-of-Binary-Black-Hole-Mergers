...
class PiStrokeFourComponentPhysicalSpin:
    ...
    def __call__(self, dataset, **params):
        ...
        s1 = _physical_spin_component(
             ...
             mu_a2=params["mu_a2_1"],
             sigma_a2=params["sigma_a2_1"],
             xi_tilt1=params["xi_tilt1_1"],
             sigma_tilt1=params["sigma_tilt1_1"],
             xi_tilt2=params["xi_tilt2_1"],
             sigma_tilt2=params["sigma_tilt2_1"],
         )
        ...
        s2 = _physical_spin_component(
             ...
             mu_a2=params["mu_a2_2"],
             sigma_a2=params["sigma_a2_2"],
             xi_tilt1=params["xi_tilt1_2"],
             sigma_tilt1=params["sigma_tilt1_2"],
             xi_tilt2=params["xi_tilt2_2"],
             sigma_tilt2=params["sigma_tilt2_2"],
         )
        ...
        s3 = _physical_spin_component(
             ...
             mu_a2=params["mu_a2_3"],
             sigma_a2=params["sigma_a2_3"],
             xi_tilt1=params["xi_tilt1_3"],
             sigma_tilt1=params["sigma_tilt1_3"],
             xi_tilt2=params["xi_tilt2_3"],
             sigma_tilt2=params["sigma_tilt2_3"],
         )
        ...
        s4 = _physical_spin_component(
             ...
             mu_a2=params["mu_a2_4"],
             sigma_a2=params["sigma_a2_4"],
             xi_tilt1=params["xi_tilt1_4"],
             sigma_tilt1=params["sigma_tilt1_4"],
             xi_tilt2=params["xi_tilt2_4"],
             sigma_tilt2=params["sigma_tilt2_4"],
         )
