...
class PiStrokeFourComponentPhysicalSpin:
    ...
    variable_names = [
        ...
        # Component 5: localized intermediate-mass component
        "mu_m1_5",
        "sigma_m1_5",
        "mu_q_5",
        "sigma_q_5",
        ...
        # Physical spin parameters: component 5
        "mu_a1_5",
        "sigma_a1_5",       
        "xi_tilt1_5",
    ...
    def __call__(self, dataset, **params):
        ...
        p5 = self.component_5(dataset, **params)
        ...
        s5 = _physical_spin_component(
            a1,
            a2,
            costilt1,
            costilt2,
            mu_a1=params["mu_a1_5"],
            sigma_a1=params["sigma_a1_5"],
            mu_a2=params["mu_a1_5"],
            sigma_a2=params["sigma_a1_5"],
            xi_tilt1=params["xi_tilt1_5"],
            sigma_tilt1=params["sigma_tilt"],
            xi_tilt2=params["xi_tilt1_5"],
            sigma_tilt2=params["sigma_tilt"],
        )
    ...
    def component_5(self, dataset, **params):
        """
        Localized intermediate-mass component.
        """

        m1 = dataset["mass_1"]
        q = dataset["mass_ratio"]

        # truncnorm is already normalized
        p_m1 = truncnorm(
            m1,
            mu=params["mu_m1_5"],
            sigma=params["sigma_m1_5"],
            low=25.0,
            high=45.0,
        )
