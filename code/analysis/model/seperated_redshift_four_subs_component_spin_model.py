...
class PiStrokeFourComponentPhysicalSpin:
    ...
    def __call__(self, dataset, **params):
        ...
        pz1 = self.p_z_component(redshift, params["kappa_1"])
        pz2 = self.p_z_component(redshift, params["kappa_2"])
        pz3 = self.p_z_component(redshift, params["kappa_3"])
        pz4 = self.p_z_component(redshift, params["kappa_4"])
