...
- `baseline_chi_eff_model_1.py`  
  Alternative LVK-like effective-spin baseline model.

- `baseline_chi_eff_model_2.py`  
  Alternative LVK-like effective-spin baseline model.
...
- `three_subs_component_spin_model.py`  
...
- `flexiable_four_subs_chi_eff_model.py`  
  Four-subpopulation model with independent `chi_eff` distributions for each subpopulation.

- `flexiable_tilt_four_subs_component_spin_model.py`  
  Four-subpopulation model with a more flexible spin-tilt distribution.

- `seperated_spin_four_subs_component_spin_model.py`  
